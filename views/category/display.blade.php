    ...
    <div style="text-align: center; "><table class="col-6 table table-bordered" id="table">
            ...
            <div>
                ...
                <tr>
                    ...
                    <td>{{$category->name}}</td>
                    <td><div ><a href="/admin/category/edit/{{$category->getId()}}"><i class="fa fa-edit fa-2x edit" title="edit"></i></a></div></td>
                    <td><div ><a href="/admin/category/delete/{{$category->getId()}}"><i class="fas fa-trash fa-2x remove" title="remove"></i></a></div></td>
                </tr>
                @endforeach
            </div>
            </tbody>
